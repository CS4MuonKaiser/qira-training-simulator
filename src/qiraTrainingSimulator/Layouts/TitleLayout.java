...
public class TitleLayout extends JFrame implements ActionListener{    
    ...
    private JButton newGame, continueGame, spellsCompendium, itemsCompendium, exit;
    ...
    public TitleLayout(){
        ...
        itemsCompendium = new JButton("ITEMS COMPENDIUM");
        ...
        itemsCompendium.setHorizontalTextPosition(JButton.LEFT);
        itemsCompendium.setContentAreaFilled(false);
        itemsCompendium.setBorderPainted(false);
        itemsCompendium.setFont(new Font("Monospaced",Font.PLAIN,15));
        itemsCompendium.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == spellsCompendium) {
            this.dispose();
            new SpellsLayout();
        } if (e.getSource() == itemsCompendium) {
            this.dispose();
            new ItemsLayout();
        } if (e.getSource() == exit) {
